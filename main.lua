...
local Window = OrionLib:MakeWindow({Name = "cracked by protogen.agency", HidePremium = false, SaveConfig = true, ConfigFolder = "sne1y.pub"}) --[[ Name = - The name of the UI. HidePremium = - Whether or not the user details shows Premium status or not. SaveConfig = - Toggles the config saving in the UI. ConfigFolder = - The name of the folder where the configs are saved. IntroEnabled = false - Whether or not to show the intro animation. IntroText = - Text to show in the intro animation. IntroIcon = - URL to the image you want to use in the intro animation. Icon = - URL to the image you want displayed on the window. CloseCallback = - Function to execute when the window is closed. ]]
...
------------------------------
print'cracked by protogen.agency'
print'░██████╗███╗░░██╗███████╗░░███╗░░██╗░░░██╗░░░██████╗░██╗░░░██╗██████╗░'
print'██╔════╝████╗░██║██╔════╝░████║░░╚██╗░██╔╝░░░██╔══██╗██║░░░██║██╔══██╗'
print'╚█████╗░██╔██╗██║█████╗░░██╔██║░░░╚████╔╝░░░░██████╔╝██║░░░██║██████╦╝'
print'░╚═══██╗██║╚████║██╔══╝░░╚═╝██║░░░░╚██╔╝░░░░░██╔═══╝░██║░░░██║██╔══██╗'
